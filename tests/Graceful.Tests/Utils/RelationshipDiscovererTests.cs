namespace Graceful.Tests
{
    ...
    public class RelationshipDiscovererTests
    {
        ...
        public void LazyManyToOneTest()
        {
            ...
            var relation1 = discoverer.Discovered[0];
            Assert.Equal(RelationshipDiscoverer.Relation.RelationType.MtoO, relation1.Type);
            Assert.Equal(typeof(Models.LazyManyToOneTestModel1), relation1.LocalType);
            Assert.Equal(typeof(Models.LazyManyToOneTestModel2), relation1.ForeignType);
            Assert.Equal(typeof(Models.LazyManyToOneTestModel1).GetProperty("Foos"), relation1.LocalProperty);
            Assert.Equal(null, relation1.ForeignProperty);
            Assert.Equal("LazyManyToOneTestModel1s", relation1.LocalTableName);
            Assert.Equal("LazyManyToOneTestModel2s", relation1.ForeignTableName);
            Assert.Equal("LazyManyToOneTestModel1", relation1.LocalTableNameSingular);
            Assert.Equal("LazyManyToOneTestModel2", relation1.ForeignTableNameSingular);
            Assert.Equal("LazyManyToOneTestModel2s", relation1.ForeignKeyTableName);
            Assert.Equal("LazyManyToOneTestModel1Id", relation1.ForeignKeyColumnName);
            Assert.Equal(null, relation1.PivotTableName);
            Assert.Equal(null, relation1.PivotTableFirstColumnName);
            Assert.Equal(null, relation1.PivotTableSecondColumnName);
            Assert.Equal(null, relation1.LinkIdentifier);
            ...
            Assert.Equal(typeof(Models.LazyManyToOneTestModel1), relation2.LocalType);
            Assert.Equal(typeof(Models.LazyManyToOneTestModel3), relation2.ForeignType);
            Assert.Equal(typeof(Models.LazyManyToOneTestModel1).GetProperty("Bars"), relation2.LocalProperty);
            Assert.Equal(null, relation2.ForeignProperty);
            Assert.Equal("LazyManyToOneTestModel1s", relation2.LocalTableName);
            Assert.Equal("LazyManyToOneTestModel3s", relation2.ForeignTableName);
            Assert.Equal("LazyManyToOneTestModel1", relation2.LocalTableNameSingular);
            Assert.Equal("LazyManyToOneTestModel3", relation2.ForeignTableNameSingular);
            Assert.Equal("LazyManyToOneTestModel3s", relation2.ForeignKeyTableName);
            Assert.Equal("LazyManyToOneTestModel1BarsId", relation2.ForeignKeyColumnName);
            Assert.Equal(null, relation2.PivotTableName);
            Assert.Equal(null, relation2.PivotTableFirstColumnName);
            Assert.Equal(null, relation2.PivotTableSecondColumnName);
            Assert.Equal("Bars", relation2.LinkIdentifier);

            var relation3 = discoverer.Discovered[2];
            Assert.Equal(RelationshipDiscoverer.Relation.RelationType.MtoO, relation3.Type);
            Assert.Equal(typeof(Models.LazyManyToOneTestModel1), relation3.LocalType);
            Assert.Equal(typeof(Models.LazyManyToOneTestModel3), relation3.ForeignType);
            Assert.Equal(typeof(Models.LazyManyToOneTestModel1).GetProperty("Bazs"), relation3.LocalProperty);
            Assert.Equal(null, relation3.ForeignProperty);
            Assert.Equal("LazyManyToOneTestModel1s", relation3.LocalTableName);
            Assert.Equal("LazyManyToOneTestModel3s", relation3.ForeignTableName);
            Assert.Equal("LazyManyToOneTestModel1", relation3.LocalTableNameSingular);
            Assert.Equal("LazyManyToOneTestModel3", relation3.ForeignTableNameSingular);
            Assert.Equal("LazyManyToOneTestModel3s", relation3.ForeignKeyTableName);
            Assert.Equal("LazyManyToOneTestModel1BazsId", relation3.ForeignKeyColumnName);
            ...
            Assert.Equal("Bazs", relation3.LinkIdentifier);
        }
